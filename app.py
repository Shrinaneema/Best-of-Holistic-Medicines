...
# Import modules
from config import setup_page, AZURE_API_KEY, AZURE_ENDPOINT, AZURE_DEPLOYMENT, AZURE_API_VERSION
from kb_manager import load_knowledge_base, create_symptom_mapping, get_treatment_info
from symptom_analyzer import find_diseases
from llm_interface import initialize_azure_client, process_natural_language_symptoms, enhance_treatment_description
...
def render_treatment_details(treatment_info, llm_mode, client, deployment):
    ...
    from disclaimers import get_disclaimer, DISCLAIMER_CSS
...
def render_ai_chat(client, deployment):
    ...
    from kb_manager import get_treatment_info
    from session_manager import add_to_chat_history
